...
{			
	public static final String SPACE = "_SPACE"; // Hack to support ' ' as a branch label. We can parse the ' ' here, but need to return a String to represent it (branch labels must are currently coupled to String values). 
	public static final String HYPHEN = "_HYPHEN";
