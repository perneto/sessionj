//$ bin/sessionj -cp tests/classes/ thesis.benchmark.bmark1.sj.SocketClient false localhost 8888 -1 10 2 1 BODY 
...
public class SocketClient extends TimerClient 
{
  public SocketClient(boolean debug, String host, int port, int cid, int serverMessageSize, int sessionLength, int iters, String flag) 
  {
  ...
  {	  	  
	  ...
	  try 
	  {
    	...
    	startTimer();
	  	...
	  	debugPrintln("[SocketClient] Connected.");
        ...
        debugPrintln("[SocketClient " + cid + "] Received: " + msg);
  ...
  public static void main(String [] args) throws Exception
  {
    ...
    new SocketClient(debug, host, port, cid, serverMessageSize, sessionLength, iters, flag).run();
  }
}
